...
def parse_args():
    ...
    parser.add_argument("--max_steps", type=int, default=500, help='max steps (override epochs)')
...
def main():
    ...
    new_model = "Meta-Llama-3-8B-for-bank-yokata"
    ...
    temp_output_dir = '/opt/ml/output/data'
    ...
    # For lora we take r=16, that gives us around 1.34M trainable parameters
    # LoRA configuration
    ...
    training_arguments = TrainingArguments(
            ...
            # warmup_steps=10,
            max_steps = args.max_steps, #comment this if you want full training
            report_to="wandb"
    )
    
    print('Set model trainer')
